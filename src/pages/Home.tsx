...
const Home: Component = () => {
	return (
		<div class="max-w-2xl">
			<div class="justify-start mb-8 mt-2 flex h-full lg:justify-center items-center">
			...
			<div class="text-left flex-grow lg:text-center mb-4 lg:mb-0">
				<div class="text-5xl md:text-6xl font-bold tracking-tight text-gray-900 dark:text-slate-100 flex justify-left lg:justify-center gap-8">
				...
				<div class="mt-10 flex items-center justify-left gap-x-6 lg:justify-center">
					<a
						href="/work"
