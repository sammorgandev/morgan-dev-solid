	...
	return (
		<div class="bg-transparent">
			<div class="mx-auto max-w-3xl text-base leading-7 text-gray-700">
				<a
					href={`/${path}`}
					class="text-base flex items-center font-semibold leading-7 text-indigo-600">
				...
				<p class="mt-6 text-xl leading-8">{post()?.body}</p>
					...
					<ul role="list" class="mt-8 max-w-xl space-y-8 text-gray-600">
						...
						<li class="flex gap-x-3">
							...
							<span>
								...
								aute id magna aliqua ad ad non deserunt sunt. Qui irure qui
